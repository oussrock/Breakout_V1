...
class Block(pygame.sprite.Sprite):
    # We use this class to creat a block that gets knocked out by the ball. We use the "Sprite" class in Pygame. 
...
def run_breaker(genomes, config):
...
while not exit_program:
    ...
    gameScore = (blockcount *5  - len(blocks)) * 50
